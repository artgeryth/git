...
| **Games** | Right-click her → **Rock-paper-scissors** or **Guess a number**, or just type it in the chat. She keeps score across restarts, gloats when she wins, makes excuses when she loses — and cheats about 8% of the time (she will deny it). |
